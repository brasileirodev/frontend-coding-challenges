...
function CharacterDetailError({ reset }: { reset: () => void }) {
  return (
    <main className="flex flex-1">
      <FeedbackState
        variant="page"
        title="Unable to load character details"
        description="The character information could not be requested. Check your connection and try again."
        actions={
          <div className="flex flex-wrap justify-center gap-3">
            <Button type="button" variant="primary" onClick={reset} className="h-auto py-2">
              Try again
            </Button>
            <Link
              to="/"
  ...
  return (
    <main className="flex flex-1">
      <FeedbackState
        ...
        description="This character does not exist or is no longer available."
        actions={
          <Link
            to="/"
